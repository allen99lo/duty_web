...
app.secret_key = os.environ.get("SECRET_KEY", "duty-schedule-dev-key")
...
MEMBER_MAP = {
    ...
    "MA": "詹文欽", "MB": "黃榮國", "NA": "范振宇",
    "NG": "王金誠", "NH": "王瑞發", "NI": "彭偉慎",
    "NM": "劉暐丞", "NN": "黃金鐘",
    "RA": "林森發", "RH": "劉錦郎", "RJ": "余金原",
...
def api_schedule(filename):
    ...
    try:
        ...
        return jsonify({"error": f"CSV 解析失敗: {e}"}), 500
    return jsonify(data)
